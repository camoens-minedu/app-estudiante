...
export class VerticalAppSidebarComponent implements OnDestroy {
  ...
  constructor(
    ...
    this.fullName = _sessionService.persona.nameProfile;
    this.nombreCarrera = _sessionService.objCarreraSelect.NombreCarrera;
    this.fotoBase64 = _sessionService.objCarreraSelect.fotoBase64;
  }
