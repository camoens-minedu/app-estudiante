...
export class FullComponent implements OnDestroy, OnInit {
  ...
  loadMenu() {
    this.opciones = this._sessionService.opciones;
    // const objUSuario = localStorage.getItem(environment.sessionStorageKeys.applicationState);
    // if (objUSuario != null) {
    //   const { opciones } = JSON.parse(objUSuario as any);
